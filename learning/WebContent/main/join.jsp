 ...
 <div class="title">회원 가입 정보 입력</div>
   <form id="memberForm" action="<%=request.getContextPath()%>/member/join.do" method="post">
        <div id="wrapper">    
			...
			<span id="idChkResult"></span><br>
            
            <div class="id regex"></div>
            
            <label>패스워드:</label><input type="password" name="mem_pass" id="mem_pass" required="" placeholder="아이디"><br>
            <div class="pw regex"></div>
            
            <label>패스워드확인:</label><input type="password" name="mem_pass2" id="mem_pass2" required="" placeholder="아이디"><br>
