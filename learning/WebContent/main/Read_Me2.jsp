...
<link rel="stylesheet" href="../css/Read_Me2.css" type="">
...
<div class="band">
		...
		<div id="content">
		 ...
		 <br>
		 <p>Facebook, Instagram, Airbnb 등 세계적인 기업에서도 활발히 사용하고<br>
		 ...
		 <h3>오늘도 <strong><em>"러닝마켓"</em></strong>   하세요💐</h3><br>
...
<div class="band2">
		...
		C#이나 JAVA와 같이 타입 정의가 필수인 언어에 익숙하다면 자바스크립트에 올인하고 싶지 않다면<br>
		타입 스크립트를 써야할 때입니다.<br>
